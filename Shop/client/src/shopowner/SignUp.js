...
export default function SignUp() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTimeout(() => navigate('/shopsignin'), 3000);
        } catch (error) {
            ...
            <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row gap-20 md:items-center">
                ...
                <div className="flex-1">
                    <div className="flex justify-center items-center">
                        <h1 className="text-3xl">Dry Cleaner</h1>
                    </div>
                    <form className='gap-4 flex flex-col' onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <TextInput autoComplete='phone' type='text' placeholder='03123456789' maxLength={11} id='number' onChange={handleChange} />
                        </div>
                        <div>
