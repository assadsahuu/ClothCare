...
const Home = () => {
  ...
  const [mapCenter, setMapCenter] = useState([33.707677, 73.022404]);
                ...
                <Card className="h-full w-full flex flex-col">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-5 mt-2.5 flex items-center">
                      ...
                      />
                      <span
                        onClick={() => navigate(`/reviews/${shp.id}`)}
                        className="ml-3 mr-2 cursor-pointer rounded bg-cyan-100 px-2.5 py-0.5 text-xs font-semibold text-cyan-800 dark:bg-cyan-200 dark:text-cyan-800"
                      >
                    ...
                    {/* Promotion banner */}
                    {shp.promotion && (
                      <div className="mt-2 p-2 bg-green-100 rounded-lg dark:bg-green-200">
                        <span className="text-green-800 text-sm font-semibold dark:text-green-900">
                          🎉 {shp.promotion.namep} - {shp.promotion.percentage}% OFF
                        </span>
                      </div>
                    )}
                  </div>
